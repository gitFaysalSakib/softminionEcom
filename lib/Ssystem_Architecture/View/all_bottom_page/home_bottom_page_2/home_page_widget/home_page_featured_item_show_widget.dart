...
class FeaturedCategoriesProductItemShow extends StatelessWidget {
          ...
          Obx(() {
            ...
            if (allProductadataController.isLoading.value) {
              return const Center(child: CircularProgressIndicator());
                ...
                .filteredProductsForFeatured.isNotEmpty) {
              ...
              return Column(
                ...
                children: [
                  ...
                  CustomProductListViewTestForFinal<AllProductsListModel>(
                    height: 200,
                    items:
                        allProductadataController.filteredProductsForFeatured,
                    ...
                    isEven:
                        allProductadataController.isEvenForTwoRowDisplay.value,
                  ),
                ],
              );
            } else {
